...
/*
Sourcelocalization (sensibilidad, confianza, energy computation) //we have to define the limits of the movement so as to avoid process overload on the NAO

moveheadheadtosource() //we recommend a 0.9 as default

movebodytosource( (distance to walk towards source)) // we have to make sure to limit de sound bounce back from the sonars.

speechrecognition(word, moduleNametoexecute)
